...
if (move_uploaded_file($_FILES['FILE']['tmp_name'], $fichero_subido)) {
    ...
    $Q="UPDATE oferentes_referencias set nombre='$NAME', tipoReferencia=$TYPE,telefono='$PHONE',celular='$CELL',direccion='$ADDRESS',ocupacion='$OCUPATION',idArchivo=$Archivo where idOferente='$USERID'";
} else {
    $Q="UPDATE oferentes_referencias set nombre='$NAME', tipoReferencia=$TYPE,telefono='$PHONE',celular='$CELL',direccion='$ADDRESS',ocupacion='$OCUPATION' where idOferente='$USERID'";
}
