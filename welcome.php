...
if($_SESSION["Rol"]==1)//Empresa
{
	...
	<div class="container">
		...
		<div class="titulo">
			<h1>Registro éxitoso (Demandante)</h1>
			<p>El proceso se ha completado éxitosamente</p>
			<a href="ADatos.php" class="btn btn-info form-control" >Actualizar Datos Básicos</a>
			<br>
			<br>
			<a href="AddVac.php" class="btn btn-info form-control" >Agregar Vacante</a>
			<br>
			<br>
		</div>
		<?php
		...
		if($cont!=0)
		{
			//require "rVacante.php";
			//require "ADatosP"
			require "crudvac.php";
		}else
		{
			require "completarD.php";
		}
		?>
	</div>
	<?php
}elseif($_SESSION["Rol"]==3)//Persona
{
	...
	if($cont!=0)
	{
		...
		?>
			<div class="container">
				<div class="titulo">
					<h1>Registro éxitoso (Oferente)</h1>
					<p>El proceso se ha completado éxitosamente</p>
					<a href="ADatos.php" class="btn btn-info form-control" >Actualizar Datos</a>
					<br>
					<br>
					<a href="AddExp.php" class="btn btn-info form-control" >Agregar Experiencia</a>
					<br>
					<br>
					<a href="AddEdu.php" class="btn btn-info form-control" >Agregar Educación</a>
					<br><br>
					<a href="AddRef.php" class="btn btn-info form-control" >Agregar Referencias</a>
					<br><br>
					<?php
					//require "editarO.php";//Actualizar Datos
					//require "crudexp.php";
					//require "crudedu.php";
